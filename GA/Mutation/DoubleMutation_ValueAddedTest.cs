...
namespace TestGeneticAlgorithmAndDataModel
{
    ...
    /// <summary>
    ///This is a test class for DoubleMutation_ValueAddedTest and is intended
    ///to contain all DoubleMutation_ValueAddedTest Unit Tests
    ///</summary>
    [TestClass()]
    public class DoubleMutation_ValueAddedTest
    {
        ...
        /// <summary>
        ///A test for DoubleMutation_ValueAdded Constructor
        ///</summary>
        [TestMethod()]
        public void DoubleMutation_ValueAddedConstructorTest()
        {
            double added = 2.0;
            DoubleMutation_ValueAdded target = new DoubleMutation_ValueAdded(added);
