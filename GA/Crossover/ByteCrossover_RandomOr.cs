...
namespace Strategies.GA.Crossover
{
    ...
    /// crossing type - 'or' (|) byte operation 
    /// </summary>
    /// <author>Alicja Salamon</author>
    class ByteCrossover_RandomOR : CrossoverIF
    {
        /// <summary>
        /// ByteCrossover_RandomOR constructor
        /// </summary>
        public ByteCrossover_RandomOR()
        {
        ...
        {
            Console.WriteLine("ByteCrossover_RandomOR");
